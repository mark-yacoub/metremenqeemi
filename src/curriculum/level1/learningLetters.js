...
const lesson1 = {
  ...
  exampleWords: [
    {word: 'Ⲛⲟⲩⲣ', pronunciation: 'nour'},
    {word: 'Ⲟⲩⲛ', pronunciation: 'oun'},
...
const lesson3 = {
  ...
  practiceWords: [
    ...
    {word: 'Ⲡ̀ⲟⲩⲣⲟ', pronunciation: 'epouro'},
...
const lesson4 = {
  ...
  practiceWords: [
    ...
    {word: 'Ⲧⲉⲛⲟⲩⲱϣⲧ', pronunciation: 'tenou-oosht'},
...
const lesson5 = {
  ...
  practiceWords: [
    ...
    {word: 'Ⲫ̀ⲛⲟⲩϯ', pronunciation: 'ephnouti'},
  ...
  practicePhrases: [
    ...
    },
    {
      ...
      pronunciation: 'ak-i ouoh aksoti emmon',
      translation: 'You came and saved us',
    },
    {
      phrase: 'Ⲁϥⲓ̀ ⲟⲩⲟϩ ⲁϥⲥⲱϯ ̀ⲙⲙⲟⲛ',
      pronunciation: 'af-i ouoh afsoti emmon',
...
const lesson7 = {
  ...
  practiceWords: [
    ...
    {word: 'Ⲉⲑⲟⲩⲁⲃ', pronunciation: 'ethouab'},
    {word: 'Ⲇⲟⲝⲁ', pronunciation: 'dhoxa'},
    {word: 'Ⲥⲑⲟⲓⲛⲟⲩϥⲓ', pronunciation: 'stoynoufi'},
    {word: 'Ⲃⲉⲛⲓ', pronunciation: 'veni'},
    {word: 'Ⲛⲟⲩⲃ', pronunciation: 'noub'},
  ],
  practicePhrases: [
    {
      phrase: 'Ϯϣⲟⲩⲣⲏ ⲛ̀ⲛⲟⲩⲃ ⲧⲉ ϯⲡⲁⲣⲑⲉⲛⲟⲥ',
      pronunciation: 'tishouree ennoub te tiparthenos',
      translation: 'The golden censer is the virgin',
    },
    {
      phrase: 'Ⲫⲁⲓ ⲡⲉ ⲡⲓⲉϩⲟⲟⲩ ⲉⲧⲁ ⲡ̀ϭⲟⲓⲥ ⲑⲁⲙⲓⲟϥ',
      pronunciation: 'phay pe pieho-ou eta epchois thamyof',
...
const lesson8 = {
  ...
  practiceWords: [
    ...
    {word: 'Ⲕ̀ⲥ̀ⲙⲁⲣⲱⲟⲩⲧ', pronunciation: 'ekesmaroo-out'},
  ...
  practicePhrases: [
    ...
    },
    {
      ...
      pronunciation: 'entefesmou eron teeren enteftouvo ennenheet',
...
const lesson9 = {
  ...
  exampleWords: [
    ...
    {word: 'Ⲭⲉⲣⲟⲩⲃⲓⲙ', pronunciation: 'sheroubim'},
  ],
  vocab: [
  ...
  practicePhrases: [
    {
      ...
      pronunciation: 'tivaki ente ephnouti Alleelouya',
